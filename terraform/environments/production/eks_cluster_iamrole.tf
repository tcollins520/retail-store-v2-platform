...
# This role is assumed by the EKS service to manage the control plane resources that is managed by AWS. It is required for all EKS clusters and must have the AmazonEKSClusterPolicy attached.
# ---------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------
